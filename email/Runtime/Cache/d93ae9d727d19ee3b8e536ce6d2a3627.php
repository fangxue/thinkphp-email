...
<table class="table table-hover">
  <tbody>
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$in): $mod = ($i % 2 );++$i;?><tr id="tr<?php echo ($in["id"]); ?>" <?php if($in["unread"] == 1): ?>style="font-weight:bold"<?php endif; ?>>
