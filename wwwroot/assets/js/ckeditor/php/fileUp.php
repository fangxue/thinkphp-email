<?php
	...
	$config = array(
        "savePath" =>  $_SERVER['DOCUMENT_ROOT']."/Uploads/" , //保存路径
        "allowFiles" => array( ".rar" , ".doc" , ".docx" , ".zip" , ".pdf" , ".txt" , ".swf", ".mkv", ".avi", ".rm", ".rmvb", ".mpeg", ".mpg", ".ogg", ".mov", ".wmv", ".mp4", ".webm",".sql",".xlsx") , //文件允许格式
    ...
    $url = '/Uploads/'.$url_array[count($url_array)-2]."/".$url_array[count($url_array)-1];
